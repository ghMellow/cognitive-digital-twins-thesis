...
|**Knowledge base**|Vector store RAG con esempi di slicing |Neo4j Knowledge Graph con vincoli operativi strutturati — più espressivo, verificabile formalmente|
|**LLM**|API cloud (DeepSeek, Qwen, Llama) |Ollama locale — zero latenza API, privacy-preserving, ma capacità ridotta|
|**Valutazione**|Metriche di sistema (BW utilization, utenti supportati) |**Gap critico**: loro non valutano il reasoning in linguaggio naturale — tu devi farlo|
