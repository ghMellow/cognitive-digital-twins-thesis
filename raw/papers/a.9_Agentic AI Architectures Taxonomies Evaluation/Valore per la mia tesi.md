...
|ChatDB / MemGPT [Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)|Eclipse Ditto come symbolic state store|Alta — Ditto è esattamente ChatDB-style: stato strutturato, query REST, paging temporale|
|CRITIC (tool-interactive validation) [Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)|Planning Agent + Neo4j KG verification|Altissima — il paper giustifica teoricamente il tuo pattern di verifica|
|MAKER Worker+Verifier [Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)|Reasoning Agent + Planning Agent separati|Alta — il pattern cross-examination è il tuo contributo di affidabilità|
|LangGraph flow engineering [Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)|La tua orchestrazione LangGraph|Diretta — il paper posiziona LangGraph come best practice per prod|
|CLASSic evaluation [Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)|Il tuo framework di valutazione|Alta — ti dà le 5 dimensioni per valutare sistemi agentici|
|Multi-agent Chain topology [Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)|La tua pipeline Percezione→Ragionamento→Pianificazione→Comunicazione|Diretta — MetaGPT/SOP-style è esattamente la tua struttura waterfall|

---

## 🔍 Aree da approfondire (in ordine di priorità per la tua tesi)

**1. Cognitive Architecture — Sezione 4.2**[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)  
...
**2. Reflection mechanisms — Sezione 4.2.2**[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)  
...
**3. Memory architecture — Sezione 4.1.2**[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)  
...
**4. Evaluation & Safety — Sezione 7**[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)  
...
**5. Multi-Agent Systems — Sezione 5**[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)  
MAKER (Worker + Verifier) è il riferimento teorico per giustificare la separazione Reasoning/Planning con verifica KG. Il paper mostra che questa separazione riduce error accumulation su reasoning chain lunghe — diretta applicazione al tuo caso.[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)
...
- Ti dà la **formalizzazione POMDP** per presentare il CDT come sistema di controllo, non come "pipeline di prompt" — questo è il cambio di framing che rende la tesi scientifica[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)
    
- La **Tabella 4** (Cognitive Architectures) ti permette di giustificare ReAct come scelta per 7-8B modelli locali senza apparire naif — è la scelta ottimale nel trade-off latenza/accuracy per hardware consumer[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)
    
- Il pattern **CRITIC + KG verification** è documentato e citable come design pattern, non come invenzione tua[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)
    
- Il **CLASSic framework** è un evaluation schema citabile che salva il Contributo 2 della tua tesi dalla genericità[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)
    
- BOLAA dimostra empiricamente che orchestrare più agenti piccoli specializzati batte un singolo modello grande — questo **giustifica la scelta di usare 7B/8B invece di un unico modello enorme**[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)
...
- La sezione evaluation ha un **gap esplicito sulla valutazione del reasoning in NL** — il paper stesso lo ammette come open problem. Questo è una conferma che il tuo Contributo 2 è genuinamente nuovo, ma anche che non trovi la soluzione nel paper[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf)
...
|---|---|---|
|[Agentic-AI-Architectures-Taxonomies-Evaluation.pdf](https://ppl-ai-file-upload.s3.amazonaws.com/web/direct-files/attachments/146803486/ef8a0d38-5202-481d-9349-6d3df0e7b5bd/Agentic-AI-Architectures-Taxonomies-Evaluation.pdf) ReAct|Yao et al., "ReAct: Synergizing Reasoning and Acting in Language Models", arXiv 2210.03629|Baseline cognitivo del tuo Reasoning Agent — citalo esplicitamente|
...
|[vizologi](https://vizologi.com/it/Spiegazione-dei-componenti-fondamentali-dell'architettura-degli-agenti-di-intelligenza-artificiale/) MetaGPT|Hong et al., "MetaGPT: Meta Programming for a Multi-Agent Collaborative Framework", ICLR 2024|SOP-based waterfall pipeline — il modello organizzativo più simile alla tua chain Percezione→Comunicazione|
...
| Ref                                                                                     | Paper                                                                                                               | Perché ti serve                                                                                             |
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| [webthesis.biblio.polito](https://webthesis.biblio.polito.it/39944/1/tesi.pdf) ReAcTree | Choi et al., "ReAcTree: Hierarchical LLM Agent Trees with Control Flow", arXiv 2511.02424                           | Alternativa gerarchica a ReAct se vuoi discutere perché non usi tree search                                 |
